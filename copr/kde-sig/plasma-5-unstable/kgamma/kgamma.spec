...
License: GPLv2
URL:     https://projects.kde.org/projects/kde/workspace/kgamma5
...
%endif
Source0: http://download.kde.org/%{stable}/plasma/%{version}/kgamma5-%{version}.tar.xz
...
Provides: kgamma5 = %{version}-%{release}
