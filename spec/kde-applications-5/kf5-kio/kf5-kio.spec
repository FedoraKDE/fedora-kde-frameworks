...
# git archive --format=tar.gz --prefix=%%{framework}-%%{version}/ \
#             --remote=git://anongit.kde.org/%%{framework}.git \
#             --output=%%{framework}-%%{git_commit}.tar.gz master
...
%changelog
* Fri Oct 24 2014 Daniel Vrátil <dvratil@redhat.com> - 5.3.50-1.20141024git5f103cb
- Git snapshot
