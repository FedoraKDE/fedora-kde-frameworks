...
#             --remote=git://anongit.kde.org/%%{framework}.git %%{git_commit}
...
%changelog
* Fri Oct 24 2014 Daniel Vrátil <dvratil@redhat.com> - 5.3.60-1.20141024gite8ad30f-1
- Git snapshot
