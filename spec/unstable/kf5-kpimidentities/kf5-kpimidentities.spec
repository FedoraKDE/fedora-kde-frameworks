%define         framework kpimidentities
%define         git_commit dda3e7d
Name:           kf5-%{framework}
Version:        4.98.0
Release:        1.20140514git%{git_commit}%{?dist}
Summary:        A Tier 3 KDE Frameworks 5 Library with PIM identities management
...
%files
%{_kf5_libdir}/libKF5PimIdentities.so.*

%files devel
%{_kf5_libdir}/libKF5PimIdentities.so
%{_kf5_libdir}/cmake/KF5PimIdentities
%{_kf5_includedir}/KPIMIdentities
%{_kf5_includedir}/kpimidentities_version.h
%{_kf5_archdatadir}/mkspecs/modules/qt_KPimIdentities.pri
%{_kf5_datadir}/dbus-1/interfaces/org.kde.pim.IdentityManager.xml

%changelog
* Wed May 14 2014 Daniel Vrátil <dvratil@redhat.com> - 4.98.0-1.20140514gitdda3e7d
- KF5 KPimIdentities 4.98.0 (git snapshot built from common kdepimlibs/frameworks repo)
