%global         framework microblog
%global         git_commit dda3e7d
Name:           kf5-%{framework}
Version:        4.98.0
Release:        1.20140514git%{git_commit}%{?dist}
Summary:        A Tier 3 KDE Frameworks 5 Library for working with microblogs
...
%files
%{_kf5_libdir}/libKF5MicroBlog.so.*

%files devel
%{_kf5_libdir}/libKF5MicroBlog.so
%{_kf5_libdir}/cmake/KF5MicroBlog
%{_kf5_includedir}/MicroBlog
%{_kf5_includedir}/microblog_version.h
%{_kf5_archdatadir}/mkspecs/modules/qt_MicroBlog.pri

%changelog
* Wed May 14 2014 Daniel Vrátil <dvratil@redhat.com> - 4.98.0-1.20140514gitdda3e7d
- KF5 MicroBlog 4.98.0 (git snapshot built from common kdepimlibs/frameworks repo)
