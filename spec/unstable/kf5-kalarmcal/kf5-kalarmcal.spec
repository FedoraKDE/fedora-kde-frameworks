%define         framework kalarmcal
%define         git_commit dda3e7d
Name:           kf5-%{framework}
Version:        4.98.0
Release:        1.20140514git%{git_commit}%{?dist}
Summary:        A Tier 3 KDE Frameworks 5 Library with API to access alarms in Akonadi
...
- KF5 Alarm Calendar 4.98.0 (git snapshot built from common kdepimlibs/frameworks repo)
