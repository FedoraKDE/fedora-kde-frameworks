%define         framework akonadi-notes
%define         git_commit 887e946
Name:           kf5-%{framework}
Version:        4.98.0
Release:        2.20140611git%{git_commit}%{?dist}
Summary:        A Tier 3 KDE Frameworks 5 Library with API to access notes in Akonadi
...
- KF5 Akonadi Notes 4.98.0 (git snapshot built from common kdepimlibs/frameworks repo)
